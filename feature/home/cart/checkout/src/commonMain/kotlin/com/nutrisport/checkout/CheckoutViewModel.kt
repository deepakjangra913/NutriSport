...
class CheckoutViewModel(
    ...
    fun updateLastName(
        ...
        screenState =
            screenState.copy(lastName = value)
    }
    ...
    fun updatePostalCode(
        ...
        screenState =
            screenState.copy(postalCode = value)
    ...
    fun updateAddress(
        ...
        screenState =
            screenState.copy(address = value)
    }
    ...
    fun payWithPayPal(
        ...
        if (totalAmount != null) {
            ...
            onError("Total amount could not be calculated.")
        }
    }
}